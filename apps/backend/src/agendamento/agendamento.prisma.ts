...
import Agendamento from '@barber/core/src/agendamento/model/Agendamento';
import RepositorioAgendamento from '@barber/core/src/agendamento/provider/RepositorioAgendamento';
